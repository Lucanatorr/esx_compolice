Locales['en'] = {
        ['go_on_duty'] = 'press ~b~[E]~s~ to go ~g~on-duty~s~ as a Community Officer',
        ['go_off_duty'] = 'press ~g~[E]~s~ to remove your vehicle and go ~r~off-duty~s~.',
        ['foot_off_duty'] = 'press ~g~[E]~s~ to go ~r~off-duty~s~.',
        ['now_on_duty'] = 'you are now ~g~on-duty~s~!',
        ['now_off_duty'] = 'your vehicle has been removed and you are now ~r~off-duty.',
        ['now_off_duty2'] = 'you are now ~r~off-duty.',
        ['already_on'] = 'you are already ~g~on-duty.',
        ['already_off'] = 'you are already ~r~off-duty.',
        ['get_vehicle'] = 'press ~b~[E]~s~ to retrieve your vehicle.',
        ['invalid_model'] = 'no valid model entered, contact development.',
        ['in_vehicle_error'] = 'you ~r~cannot~s~ be inside a vehicle to go on duty.',
        ['cannot_preform'] = 'cannot do that while ~r~off-duty~s~.',
        ['invalid_job'] = 'you do not have the ~g~Community Police~s~ job.',
        ['map2_blip'] = 'Community Police Station',
        ['request_backup'] = 'request backup',
        ['send_message'] = 'a community police officer has requested assistance.',
        ['message_sent'] = 'message has been ~b~sent~s~.',



------LOCALES FROM ESX_POLICEJOB SINCE YOU CANT HAVE MORE THAN 1 EN.LUA LOCALE--------
